...
export default function WomenPage() {
  ...
  const fetchProducts = async () => {
    try {
      ...
      // Filter for women's products if API doesn't filter
      const womenProducts = productsArray.filter(
        p => p.category.name.toLowerCase() === 'women'
      );
    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="bg-gray-100 py-12">
        <div className="max-w-7xl mx-auto px-6">
          <h1 className="text-4xl font-bold text-gray-900 mb-2">Women's Collection</h1>
