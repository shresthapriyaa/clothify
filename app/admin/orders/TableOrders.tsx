...
export function TableOrders({ orders, users, products, handleUpdateLocalState }: ITableOrdersProps) {
    return (
        <div className="p-8 min-h-screen bg-white text-black min-w-full rounded-2xl ">
            <div className="border border-black/20 rounded-lg border-b-4 border-t-4">
                <Table>
                    <TableHeader>
                        <TableRow>
                            <TableHead className="w-[100] font-semibold text-black text-left px-4 py-2 border-b-2">ID</TableHead>
                            <TableHead className="text-black px-4 py-2 font-semibold border-b-2">USER</TableHead>
                            <TableHead className="text-black px-4 py-2 font-semibold border-b-2">TOTAL</TableHead>
                            <TableHead className="text-black px-4 py-2 font-semibold border-b-2">PRODUCTS</TableHead>
                            <TableHead className="text-black px-4 py-2 font-semibold border-b-2">CREATED AT</TableHead>
